...
data = CSV.read("google_data/Google_Test_Data_pot.csv", datarow=1, header=["arribo", "arriboAbsoluto", "permanencia", "tiempoCarga"],types=[Float64, Float64, Float64, Float64])
